...
def generate_r1_messages(example):
    ...
    If the block is not ok, please determine the smallest bounding box that contains the entire defect. Express this bounding box as [x_min, y_min, x_max, y_max]. This bounding box should be with respect to the input_image rather than any other images generated by tools you use.
