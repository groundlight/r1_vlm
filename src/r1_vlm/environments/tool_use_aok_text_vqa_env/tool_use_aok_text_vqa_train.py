...
from r1_vlm.environments.tool_use_aok_text_vqa_env.tool_use_aok_text_vqa_env import (
    AOKAndTextVQAToolEnv,
)

os.environ["WANDB_ENTITY"] = "groundlightai"
os.environ["WANDB_PROJECT"] = "tool-use-aok-text-vqa-env"
...
def train():
    ...
    vf_env = AOKAndTextVQAToolEnv(processing_class=processor, max_steps=3)
    ...
    training_args = GRPOConfig(
        ...
        output_dir="vlm-r1-aok-text-vqa-0_5-score-with-structured-output-may19-beta-0-3B",
...
# CUDA_VISIBLE_DEVICES=0,1,2,3 uv run accelerate launch --config_file src/r1_vlm/deepspeed_configs/multi_gpu_3only.yaml src/r1_vlm/environments/tool_use_aok_text_vqa_env/tool_use_aok_text_vqa_train.py
