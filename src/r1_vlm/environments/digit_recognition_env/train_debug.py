...
os.environ["WANDB_PROJECT"] = "digit-recognition-clip-high-env"
...
def train():
    ...
    training_args = GRPOConfig(
        ...
        output_dir="vlm-r1-digit-recognition-clip-high-env",
        ...
        report_to="wandb",
        vllm_device="cuda:4" if torch.cuda.device_count() == 5 else "cuda:3",
        epsilon_low=0.2,
        epsilon_high=0.28,
    )
