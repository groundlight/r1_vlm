...
from r1_vlm.environments.message_decoding_abc_zoom_in_env.message_decoding_abc_zoom_in_env import (
    MessageDecodingABCZoomInEnv,
)
...
os.environ["WANDB_PROJECT"] = "message-decoding-abc-zoom-in"
...
vf_env = MessageDecodingABCZoomInEnv(
    processing_class=processor,
    dataset_name="Groundlight/message-decoding-abc-zoom-in-r1",
    max_steps=3,
)
...
training_args = GRPOConfig(
    ...
    output_dir="vlm-r1-message-decoding-abc-zoom-in",
    learning_rate=1e-6,
    adam_beta2=0.98,
...
trainer = QwenGRPOTrainer(
    ...
    env=vf_env,
    inputs_to_log=["decoded_message", "coded_message"],
)

trainer.train()

#CUDA_VISIBLE_DEVICES=0,1,2,3 uv run accelerate launch --config_file src/r1_vlm/deepspeed_configs/multi_gpu_3only.yaml src/r1_vlm/environments/message_decoding_abc_zoom_in_env/train.py
