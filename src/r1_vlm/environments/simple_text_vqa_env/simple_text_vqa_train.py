...
# I'm using this as a baseline against tool use, so keeping it in this project
...
def train():
    ...
    training_args = GRPOConfig(
        ...
        output_dir="vlm-r1-text-vqa-clip-gradnorm-1.0-beta0.0-only-hard-examples-no-tool-use-baseline-may10-3B",
...
# CUDA_VISIBLE_DEVICES=0,1,2,3 uv run accelerate launch --config_file src/r1_vlm/deepspeed_configs/multi_gpu_3only.yaml src/r1_vlm/environments/simple_text_vqa_env/simple_text_vqa_train.py
