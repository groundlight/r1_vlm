...
if __name__ == "__main__":
    MODEL_PATH = "/millcreek/home/sunil/r1_vlm/vlm-r1-text-vqa-clip-gradnorm-1.0-beta0.0-only-hard-examples-no-tool-use-baseline-restart-may10-3B/checkpoint-600"
    results_file_path = "/millcreek/home/sunil/r1_vlm/src/r1_vlm/environments/simple_text_vqa_env/eval_baseline_step800_validation_results.jsonl"
