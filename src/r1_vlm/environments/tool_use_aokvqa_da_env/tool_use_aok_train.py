...
from r1_vlm.environments.tool_use_aokvqa_da_env.tool_use_aokvqa_da_env import (
    AOKVQA_DA_ToolEnv,
)

os.environ["WANDB_ENTITY"] = "groundlightai"
os.environ["WANDB_PROJECT"] = "tool-use-aokvqa-da-env"
...
def train():
    ...
    vf_env = AOKVQA_DA_ToolEnv(processing_class=processor, max_steps=3)
    ...
    training_args = GRPOConfig(
        ...
        output_dir="vlm-r1-aokvqa-da-may2-3B",
...
# CUDA_VISIBLE_DEVICES=0,1,2,3 uv run accelerate launch --config_file src/r1_vlm/deepspeed_configs/multi_gpu_3only.yaml src/r1_vlm/environments/tool_use_aokvqa_da_env/tool_use_aok_train.py
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 uv run accelerate launch --config_file src/r1_vlm/deepspeed_configs/multi_gpu_6only.yaml src/r1_vlm/environments/tool_use_aokvqa_da_env/tool_use_aok_train.py
