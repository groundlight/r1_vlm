...
def train():
    checkpoint = "/millcreek/home/sunil/r1_vlm/vlm-r1-simple-aokvqa-env-cliphigh-ssr-no-format-reward/checkpoint-500"
    ...
    training_args = GRPOConfig(
        ...
        output_dir="vlm-r1-simple-aokvqa-env-cliphigh-ssr-no-format-reward-restart-with-buffer-improvements",
