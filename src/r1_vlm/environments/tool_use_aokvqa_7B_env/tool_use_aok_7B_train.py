...
from r1_vlm.environments.tool_use_aokvqa_7B_env.tool_use_aokvqa_7B_env import (
    AOKVQAToolEnv,
)
...
def train():
    checkpoint = "/workspace/vlm-r1-tool-use-aokvqa-env/checkpoint-50"
    ...
    training_args = GRPOConfig(
        ...
        output_dir="/workspace/vlm-r1-tool-use-aokvqa-env-restart",
...
# CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6 uv run accelerate launch --config_file src/r1_vlm/deepspeed_configs/multi_gpu_6only.yaml src/r1_vlm/environments/tool_use_aokvqa_7B_env/tool_use_aok_7B_train.py
