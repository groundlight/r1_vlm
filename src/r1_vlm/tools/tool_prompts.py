...
As a reminder, you are not required to use a tool if you can answer the user's question without one.
"""

# removed image_name from tool calls
SINGLE_TOOL_PROMPT_TEMPLATE_SIMPLIFIED = """\
You may call any of the tools exactly one time. You have access to the following tools to help solve problems: 
